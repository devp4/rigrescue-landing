...
const problems = [
  {
    ...
    title: 'For Drivers',
    description:
      "Your truck won't start at a rest stop. You pull up Google, start calling shops. Half don't answer. Half don't do mobile service. The one who picks up is hours away. Every hour you wait costs time and money.",
  },
  {
    icon: Wrench,
    title: 'For Shop Owners & Independent Techs',
    description:
    ...
    <section className="py-20 lg:py-32 bg-background">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-xl md:text-2xl font-semibold text-foreground">
          There has to be a <span className="text-primary">better way.</span>
        </p>
      </div>
    </section>
  );
